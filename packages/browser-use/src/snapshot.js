 ...
 *
 * Refs are reissued from e1 on every snapshot, so a ref from an earlier
 * snapshot is never silently reused against a different node — a stale ref is
 * either absent or wrong, and absent is the only safe failure.
 */
