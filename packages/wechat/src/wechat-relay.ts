 ...
 */
export async function probeWeChatRelay(nativeOnly = false): Promise<WeChatRelayStatus> {
  ...
  if (nativeOnly) return {running: false, account: null, error: null, installUrl: null};
