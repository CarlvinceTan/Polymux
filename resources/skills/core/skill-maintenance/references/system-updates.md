...
State lives under `~/.polymux/skill-maintenance/system-updates`. This directory
...
Detection copies the bundled skills from the installed Polymux app bundle into an
