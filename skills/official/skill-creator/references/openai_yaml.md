...
- Give personal skills distinct, purpose-relevant icons when the ChatGPT surface
  ...
  the field.
- Verify referenced icon files exist and visually remain understandable at the
  small size used in the skill picker.
