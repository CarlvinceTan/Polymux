...
```bash
/opt/homebrew/bin/python3.14 ~/.codex/github-skill-updater/enroll_skill.py --sync-locks
```
...
```bash
/opt/homebrew/bin/python3.14 ~/.codex/github-skill-updater/enroll_skill.py \
  --skill <skill-name> \
