...
- Before any discovery or call that may initialize, reveal, or control a local GUI app, load `window-control` and follow its current route. This skill does not duplicate GUI mechanics.
