/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 75ebef4a5299841749cdbef5fb0eb9a5)
...
interface __BaseEnv_Env {
	...
	CONNECT_CODES: DurableObjectNamespace<import("./src/index").ConnectCodeRegistry>;
	CONNECT_LIMITER: DurableObjectNamespace<import("./src/index").ConnectAttemptLimiter>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "HostRelay" | "ConnectCodeRegistry" | "ConnectAttemptLimiter";
	}
