...
import {vaultChecksum, type LockerCloudBlob} from "@polymux/locker";
import type {AccountService} from "../account/account-service.js";
import {SupabaseLockerCloud} from "./cloud.js";
...
function fixture() {
  ...
  return {cloud: new SupabaseLockerCloud(account), objects, failCommit(value: boolean) { failCommit = value; }};
}

function blob(revision: number, value: number): LockerCloudBlob {
