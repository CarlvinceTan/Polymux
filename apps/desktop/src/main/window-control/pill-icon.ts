...
/**
 * The window-control pill's picture: a capsule holding the icons of the apps
  ...
  constructor(options: PillIconOptions) {
    this.#helper = new SwiftHelper({
      ...
      missingCompilerMessage:
        "The window-control pill needs the Swift compiler. Install the Xcode Command Line Tools: xcode-select --install",
