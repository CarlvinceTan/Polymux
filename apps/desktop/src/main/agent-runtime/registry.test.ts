...
test("ACP registry distributions become launch presets", () => {
  assert.deepEqual(parseAcpRegistry({agents: [
    ...
    {id: "python", name: "Python agent", distribution: {uvx: {package: "python-agent", args: ["serve"], env: {FAST_AGENT_MODEL: "codexplan", "invalid-key": "ignored", SECRET: 42}}}},
    ...
    {id: "python", name: "Python agent", version: "", description: "", icon: "", installed: false, command: "uvx", args: ["python-agent", "serve"], environment: {FAST_AGENT_MODEL: "codexplan"}},
