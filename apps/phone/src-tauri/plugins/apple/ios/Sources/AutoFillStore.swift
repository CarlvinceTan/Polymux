...
enum AutoFillStore {
    static let group = "group.com.flarehq.polymux.phone"
    static var query: [String: Any] {
        [kSecClass as String: kSecClassGenericPassword,
         kSecAttrService as String: "com.flarehq.polymux.phone.autofill",
         kSecAttrAccount as String: "credentials",
         kSecAttrAccessGroup as String: "23YB4896XA.com.flarehq.polymux.phone.locker"]
    }
    ...
    static func load() throws -> [AutoFillEntry] {
        ...
        item[kSecUseOperationPrompt as String] = "Unlock Polymux Locker"
    ...
    static func failure(_ message: String) -> NSError {
        NSError(domain: "PolymuxLocker", code: 1, userInfo: [NSLocalizedDescriptionKey: message])
    }
}
