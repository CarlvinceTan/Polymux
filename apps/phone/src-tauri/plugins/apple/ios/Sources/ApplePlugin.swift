...
final class ApplePlugin: Plugin, ASAuthorizationControllerDelegate, ASAuthorizationControllerPresentationContextProviding, ASWebAuthenticationPresentationContextProviding {
    ...
    @objc func oauth(_ invoke: Invoke) {
        do {
            ...
            DispatchQueue.main.async {
                ...
                let session = ASWebAuthenticationSession(url: url, callbackURLScheme: "polymux-phone") { callback, error in
                    self.webSession = nil
                    guard let callback, callback.scheme == "polymux-phone", callback.host == "auth", callback.path == "/callback" else {
    ...
    private func query(_ key: String) throws -> [String: Any] {
        ...
        return [kSecClass as String: kSecClassGenericPassword,
                kSecAttrService as String: "com.flarehq.polymux.phone.account",
